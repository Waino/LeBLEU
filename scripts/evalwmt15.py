...
# chosen using average of wmt13 and wmt14.
# Finnish chosen to be same as German
LANGPAIR_OPTIMA_SEG = {
    'en-fr': {'max_n': 4, 'threshold': 0.7},
    'en-fi': {'max_n': 3, 'threshold': 0.2},
    'en-de': {'max_n': 3, 'threshold': 0.2},
    'en-cs': {'max_n': 2, 'threshold': 0.3},
    'en-ru': {'max_n': 2, 'threshold': 0.3},

    'fr-en': {'max_n': 3, 'threshold': 0.6},
    'fi-en': {'max_n': 4, 'threshold': 0.5},
    'de-en': {'max_n': 4, 'threshold': 0.5},
    'cs-en': {'max_n': 4, 'threshold': 0.5},
    'ru-en': {'max_n': 4, 'threshold': 0.5},
}
LANGPAIR_OPTIMA_SYS = {
    'en-fr': {'max_n': 4, 'threshold': 0.4},
    'en-fi': {'max_n': 4, 'threshold': 0.2},
    'en-de': {'max_n': 4, 'threshold': 0.2},
    'en-cs': {'max_n': 4, 'threshold': 0.3},
    'en-ru': {'max_n': 2, 'threshold': 0.2},

    'fr-en': {'max_n': 4, 'threshold': 0.6},
    'fi-en': {'max_n': 4, 'threshold': 0.4},
    'de-en': {'max_n': 4, 'threshold': 0.4},
    'cs-en': {'max_n': 4, 'threshold': 0.7},
    'ru-en': {'max_n': 4, 'threshold': 0.3},
}
...
if __name__ == "__main__":
    ...
    for trfile in trfiles:
        ...
        if not os.path.exists(reffile):
            logging.warning("Skipping tr '{}' due to lack of ref '{}'".format(
                trfile, reffile))
            continue
